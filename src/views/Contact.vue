...
const sendMessage = async () => {
    try {
        ...
        formData.append("shootType", selectedShootType.value);
        formData.append("shootDate", shootDate.value);
        formData.append("referral", selectedReferral.value === "Other" ? otherReferral.value : selectedReferral.value);
        ...
        const response = await fetch("https://formsubmit.co/ogodogublessing1@gmail.com", {
            method: "POST",
            body: formData,
        });
...
//                 referral: selectedReferral.value === "Other" ? otherReferral.value : selectedReferral.value,
                ...
                <div class="contact-us-text">
                  ...
                  <form @submit.prevent="sendMessage">
                    ...
                    <div class="contact-form">
                        ...
                        <input type="phone" v-model="phone" placeholder="Your Phone Number" required>
                    </div>
                    <div class="contact-form">
                        <label for="shootType">Type of Shoot <span class="red"> * </span></label>  
                      <select v-model="selectedShootType" required>
                    ...
                    <div class="contact-form">
                        ...
                        <input type="date" v-model="shootDate" Place required>
                    </div>    
                    <div class="contact-form">
                        <label for="shootDate">How did you hear about us? (include referral if you have one)<span class="red"> * </span></label>
                        <select v-model="selectedReferral" required>
                            <option value="" disabled selected>Select </option>
                            <option v-for="option in referralOptions" :key="option" :value="option">{{ option }}</option>
                        </select>   
                        <input v-if="selectedReferral === 'Other'" type="text" v-model="otherReferral" placeholder="Please specify" required>
                    </div>
                    <div class="contact-form">
                ...
                <div class="contact-us-icons" >
                     <div>
                        <div class ="contact-us-svg">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50px" height="50px" viewBox="0 0 24 24"><path fill="#fff" d="M20.891 2.006L20.997 2l.13.008l.09.016l.123.035l.107.046l.1.057l.09.067l.082.075l.052.059l.082.116l.052.096q.07.15.09.316l.005.106q0 .113-.024.22l-.035.123l-6.532 18.077A1.55 1.55 0 0 1 14 22.32a1.55 1.55 0 0 1-1.329-.747l-.065-.127l-3.352-6.702l-6.67-3.336a1.55 1.55 0 0 1-.898-1.259L1.68 10c0-.56.301-1.072.841-1.37l.14-.07l18.017-6.506l.106-.03l.108-.018z"/>
                            </svg>
                            <p>456 Main street, Buckingham Av. XV34 London</p>
                        </div>
                        <div class ="contact-us-svg">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50px" height="50px" viewBox="0 0 32 32"><path fill="#fff" d="M10.25 2A3.25 3.25 0 0 0 7 5.25v21.5A3.25 3.25 0 0 0 10.25 30h11.5A3.25 3.25 0 0 0 25 26.75V5.25A3.25 3.25 0 0 0 21.75 2zM14 24h4a1 1 0 1 1 0 2h-4a1 1 0 1 1 0-2"/>
                            </svg>
                            <p>+44 7507 971045</p>
                        </div>
                        <div class ="contact-us-svg">
